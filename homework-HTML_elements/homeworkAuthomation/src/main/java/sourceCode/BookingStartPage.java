...
import htmlelements.SignInForm;
...
public class BookingStartPage {
	...
	public void enterLogin(String login) {
		...
		signInForm.emailAddressField.sendKeys(login);
	}

	@Step
	public void enterPassword(String pass) {
		signInForm.passwordField.sendKeys(pass);
	}

	@Step
	public UserProfilePage submitCredentials() {
		signInForm.signInForm.submit();
	...
	public void setEnglishLanguage() {
		Browser.waitForVisibility(driver, bookingHeader.languageChangingButton);
		if (bookingHeader.defaultEnglish != null) {

			Browser.moveToElementAndClick(driver, bookingHeader.languageChangingButton);
